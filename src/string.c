...
* 10/26/00   1.00  Modified for LinIce                             Goran Devic
* --------   ----  ---------------------------------------------   -----------
*******************************************************************************
*   Include Files
******************************************************************************/
...
static char *_sErrors[MAX_ERRNO+1] =    // Error strings for strerror()
{
    "Invalid error code",
    "Arguments and environment is larger than ARG_MAX",
    "Search file permission is denied",
    "O_NONBLOCK flag is set or not enough resources",
    "Invalid file descriptor",
    "The directory is in use",
    "There are no children",
    "An fcntl would cause a deadlock",
    "Input argument is outside math domain",
    "The name file already exists",
    "Invalid address in an arggument to a function call",
    "File exceeds maximum file size",
    "Function was interrupted by a signal",
    "Invalid argument",
    "Input or output error",
    "A name is a directory",
    "Too many file descriptors used by a process",
    "The number of links exceeds LINK_MAX",
    "Length of a filename exceeds PATH_MAX",
    ...
    "Cant delete or rename a non-empty directory",
    "A file is not a terminal",
    "No such device",
    "Operation is not permitted",
    "Attempt to write to a pipe with no reader",
    "Result is too large",
    "Read-only file system",
    "An lseek was issued on a pipe or fifo",
    "No such process",
