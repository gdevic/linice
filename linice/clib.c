...
*******************************************************************************
    ...
    Module Description:
        ...
        This module contains local C-library functions.
...
* --------   ---------------------------------------------------  ----------- *
* 08/24/96   Initial version                                      Goran Devic *
* 03/05/01   Modified for LinIce renamed clib (was string.c)      Goran Devic *
* --------   ---------------------------------------------------  ----------- *
*******************************************************************************
*   Include Files                                                             *
******************************************************************************/

#include "clib.h"                       // Include its own header file
...
*
******************************************************************************/
void * ice_memchr( const void *s, int c, size_t n)
{
    if( n==0 ) return( NULL );
...
*
******************************************************************************/
int ice_memcmp( const void *s1, const void *s2, size_t n)
{
    if( n==0 ) return( 0 );
...
*
******************************************************************************/
void * ice_memcpy( void *s1, const void *s2, size_t n)
{
    char *original = s1;
...
*
******************************************************************************/
void * ice_memmove( void *s1, const void *s2, size_t n)
{
    char *original = s1;
...
*
******************************************************************************/
char * ice_strcat( char *s1, const char *s2 )
{
    char *original = s1;
...
*
******************************************************************************/
char * ice_strchr( const char *s, int c )
{
    while( *s != c )
    {
        if( *s == 0 )
...
*
******************************************************************************/
int ice_strcoll( const char *s1, const char *s2 )
{
    // This implementation does not support locale
    return( ice_strcmp(s1,s2) );
}
...
*
******************************************************************************/
char * ice_strcpy( char *s1, const char *s2 )
{
    char *original = s1;
...
*
******************************************************************************/
size_t ice_strcspn( const char *s1, const char *s2 )
{
    char *scan1;
    char *scan2;
    int count;
...
*
******************************************************************************/
size_t ice_strlen( const char *s )
{
...
*
******************************************************************************/
char * ice_strncat( char *s1, const char *s2, size_t n )
{
    char *original = s1;
...
*
******************************************************************************/
char * ice_strncpy( char *s1, const char *s2, size_t n )
{
    char *original = s1;
...
*
******************************************************************************/
char * ice_strpbrk( const char *s1, const char *s2 )
{
    char *scan1;
    char *scan2;
...
*
******************************************************************************/
char * ice_strrchr( const char *s, int c )
{
    char *last = NULL;
...
*
******************************************************************************/
size_t ice_strspn( const char *s1, const char *s2 )
{
    char *scan;
    int len;
...
*
******************************************************************************/
char * ice_strstr( const char *s1, const char *s2 )
{
    char *orig;
    char *scan;
...
*
******************************************************************************/
char * ice_strtok( char *s1, const char *s2 )
{
    char *last;
    static char *str;
    ...
    str += ice_strspn( s1, s2 );
    if( *str==0 ) return( NULL );

    // Find the end of the token
    last = ice_strpbrk( str, s2 );
    s1 = str;
    str = last;
    *str++ = 0;
...
*
******************************************************************************/
size_t ice_strxfrm( char *s1, const char *s2, size_t n )
{
    // This implementation does not support locale
    ice_strncpy( s1, s2, n );
    return( ice_strlen(s2) );
}
...
*
******************************************************************************/
void * ice_memccpy( void *s1, const void *s2, int c, size_t n )
{
    if( n==0 ) return( NULL );
...
*
******************************************************************************/
int ice_memicmp( const void *s1, const void *s2, size_t n )
{
    if( n==0 ) return( 0 );

    while( n-- )
    {
        if (ice_tolower(*(unsigned char *)s1) != ice_tolower(*(unsigned char *)s2))
            return(ice_tolower(*(unsigned char *)s1) - ice_tolower(*(unsigned char *)s2));
        s1 = (unsigned char *)s1 + 1;
        s2 = (unsigned char *)s2 + 1;
    }
...
*
******************************************************************************/
int ice_strcmpi( const char *s1, const char *s2 )
{
    while( 1 )
    {
        if (ice_tolower(*s1) != ice_tolower(*s2)) return(ice_tolower(*s1) - ice_tolower(*s2));
        if (*s1 == 0) return(0);
        s1++;
        s2++;
    }
...
*
******************************************************************************/
char * ice_strdup( const char *string )
{
    char *new;

    new = ice_malloc( ice_strlen(string) + 1);

    if( new == NULL )
        return( NULL );

    return( ice_strcpy(new, string) );
}
...
*
******************************************************************************/
int ice_stricmp( const char *s1, const char *s2 )
{
    while( 1 )
    {
        if (ice_tolower(*s1) != ice_tolower(*s2)) return(ice_tolower(*s1) - ice_tolower(*s2));
...
*
******************************************************************************/
int ice_strnicmp( const char *s1, const char *s2, size_t n )
{
    if( n==0 ) return( 0 );
    while( 1 )
    {
        if (ice_tolower(*s1) != ice_tolower(*s2))
            return(ice_tolower(*s1) - ice_tolower(*s2));
        if (*s1 == 0 || --n == 0) return(0);
        s1++;
        s2++;
    }
...
*
******************************************************************************/
char * ice_strnset( char *s, int c, size_t n )
{
    char *scan;
