...
PCIHDR.H: PCI Vendors, Devices, and Class Type information
  ...
  This header created on Sat, 21 Apr 2001 09:53:51 UTC
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x1002, 0x5048, "Rage 128 Pro PH AGP ", "" } ,
	{ 0x1002, 0x5049, "Rage 128 Pro PI AGP ", "" } ,
	{ 0x1002, 0x504A, "Rage 128 Pro PJ PCI", "" } ,
	{ 0x1002, 0x504B, "Rage 128 Pro PK AGP ", "TMDS" } ,
	{ 0x1002, 0x504C, "Rage 128 Pro PL AGP ", "TMDS" } ,
	{ 0x1002, 0x504D, "Rage 128 Pro PM PCI", "" } ,
	{ 0x1002, 0x504E, "Rage 128 Pro PN AGP ", "" } ,
	{ 0x1002, 0x504F, "Rage 128 Pro PO AGP ", "" } ,
	{ 0x1002, 0x5050, "Rage 128 Pro PP PCI", "TMDS" } ,
	{ 0x1002, 0x5051, "Rage 128 Pro PQ AGP ", "TMDS" } ,
	{ 0x1002, 0x5052, "Rage 128 Pro PR AGP ", "TMDS" } ,
	{ 0x1002, 0x5053, "Rage 128 Pro PS PCI", "" } ,
	{ 0x1002, 0x5054, "Rage 128 Pro PT AGP ", "" } ,
	{ 0x1002, 0x5055, "Rage 128 Pro PU AGP ", "" } ,
	{ 0x1002, 0x5056, "Rage 128 Pro PV PCI", "TMDS" } ,
	{ 0x1002, 0x5057, "Rage 128 Pro PW AGP ", "TMDS" } ,
	{ 0x1002, 0x5058, "Rage 128 Pro PX AGP ", "TMDS" } ,
	{ 0x1002, 0x5144, "", "Radeon DDR/SDR" } ,
	{ 0x1002, 0x5159, "Radeon VE", "" } ,
	...
	{ 0x1002, 0x5345, "", "Rage 128 SE PCI" } ,
	{ 0x1002, 0x5346, "", "Rage 128 SF AGP 2x" } ,
	{ 0x1002, 0x5347, "", "Rage 128 SG AGP 4x" } ,
	{ 0x1002, 0x5348, "", "Rage 128 SH" } ,
	{ 0x1002, 0x534B, "Rage 128 SK PCI", "" } ,
	{ 0x1002, 0x534C, "Rage 128 SL AGP 2x", "" } ,
	{ 0x1002, 0x534D, "Rage 128 SM AGP 4x", "" } ,
	...
	{ 0x1014, 0x170, "RC1000", "Rasterizer/IBM GT1000 Geometr" } ,
	...
	{ 0x1022, 0x7004, "AMD-751", "CPU to PCI Bridge (SMP chipset)" } ,
	...
	{ 0x1023, 0x9910, "", "Trident CyberBlade XP" } ,
	...
	{ 0x102B, 0x1000, "MGA-G100", "Productiva G100 Multi-Monitor" } ,
	...
	{ 0x1039, 0x0635, "SiS 635", "" } ,
	{ 0x1039, 0x0730, "SiS 730x", "" } ,
	{ 0x1039, 0x0735, "SiS 735", "" } ,
	{ 0x1039, 0x0740, "SiS 740", "" } ,
	...
	{ 0x104C, 0x8009, "TSB12LV22", "OHCI-Lynx IEEE 1394 Host Ctrlr" } ,
	...
	{ 0x1057, 0x0003, "MPC8240", "MPC8240 PowerPC Integrated Processor" } ,
	...
	{ 0x10b5, 0x9610, "PCI 9610", "64-bit 66 MHz PCI Master I/O Accelerator" } ,
	...
	{ 0x10DE, 0x0103, "NV10", "GeForce 256 GL (Quadro)" } ,
	{ 0x10DE, 0x0110, "NV11", "GeForce 2 MX" } ,
	{ 0x10DE, 0x0111, "NV11 DDR", "GeForce2 MX DDR" } ,
	{ 0x10DE, 0x0112, "NV11", "GeForce2 MX Ultra" } ,
	{ 0x10DE, 0x0113, "NV11 GL", "GeForce2 MX GL (Quadro2 MXR)" } ,
	{ 0x10DE, 0x0150, "NV15", "GeForce2 GTS/Pro" } ,
	{ 0x10DE, 0x0151, "NV15 DDR", "GeForce2 GTS DDR" } ,
	{ 0x10DE, 0x0152, "NV15 Bladerunner", "GeForce2 GTS Ultra" } ,
	{ 0x10DE, 0x0153, "NV15 GL", "GeForce2 GTS GL (Quadro2 Pro)" } ,
	{ 0x10De, 0x01A0, "Crush11", "Integrated graphics" } ,
	...
	{ 0x10E8, 0x4750, "S5933/35", "PCI Ctrlr" } ,
	...
	{ 0x1106, 0x0130, "VT6305", "1394.A OHCI Link Layer Controller" } ,
	...
	{ 0x1106, 0x0505, "82C5x5", "CPU to PCI and PCI to ISA Bridge" } ,
	...
	{ 0x1106, 0x0601, "VT8601", "ProMedia PM601 System Controller" } ,
	...
	{ 0x1106, 0x3059, "", "AC97 Enhanced Audio Controller" } ,
	{ 0x1106, 0x3065, "", "Fast Ethernet Adapter" } ,
	...
	{ 0x1106, 0x3099, "Vt8366", "CPU to PCI Bridge" } ,
	{ 0x1106, 0x3101, "VT8653", "CPU to PCI Bridge" } ,
	{ 0x1106, 0x3102, "VT8662", "CPU to PCI Bridge" } ,
	...
	{ 0x1106, 0x8235, "", "Power Management Controller" } ,
	{ 0x1106, 0x8305, "VT8363", "PCI to AGP Bridge" } ,
	{ 0x1106, 0x8391, "VT8371", "PCI to AGP Bridge" } ,
	{ 0x1106, 0x8501, "VT8501", "MVP4 PCI to AGP Bridge" } ,
	...
	{ 0x1106, 0x8601, "VT82C601", "PM601 CPU to AGP Bridge" } ,
	{ 0x1106, 0x8602, "", "CPU to AGP Controller" } ,
	{ 0x1106, 0x8605, "VT8605", "PM133 CPU to AGP Bridge" } ,
	{ 0x1106, 0x8691, "VT82C691/693A/694X", "Apollo Pro/133/133A PCI-to-PCI Bridge" } ,
	{ 0x1106, 0x8693, "VT82C693", "Apollo Pro+ PCI-to-PCI Bridge" } ,
	{ 0x1106, 0xB091, "VT8633", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB099, "VT8366", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB101, "VT8653", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB102, "VT8362", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB103, "VT8615", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB112, "VT8361", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB115, "", "CPU to AGP Controller" } ,
	{ 0x1106, 0xB133, "", "CPU to AGP Controller" } ,
	...
	{ 0x127A, 0x1005, "r6793-21", "HCF 56k V.90 Speakerphone Modem" } ,
	{ 0x127A, 0x1023, "", "V.90 Modem" } ,
	{ 0x127A, 0x1024, "", "HCF 56k PCI Modem" } ,
	...
	{ 0x127A, 0x4310, "", "Master Riptide PCI Audio Device" } ,
	{ 0x127A, 0x4311, "", "Conexant PCI Modem Enumerator" } ,
	...
	{ 0x12AE, 0x0001, "ACENIC", "Gbit ethernet adapter" } ,
	...
	{ 0x14f1, 1036, "", "Communications Controller" } ,
	...
	{ 0x8086, 0x2531, "82860", "Host-Hub Interface Bridge (DP mode)" } ,
	...
	{ 0x8086, 0x7110, "82371AB/EB", "PIIX4 ISA Bridge" } ,
	{ 0x8086, 0x7111, "82371AB/EB", "PIIX4 IDE Controller" } ,
	{ 0x8086, 0x7112, "82371AB/EB", "PIIX4 USB Interface" } ,
	{ 0x8086, 0x7113, "82371AB/EB", "PIIX4 Power Management Controller" } ,
	...
	{ 0x8086, 0x7127, "82810E", "Graphics Device (FSB 133 MHz)" } ,
	...
	{ 0x8086, 0x7196, "82443MX?", "AC97 Modem Controller" } ,
	...
	{ 0x8086, 0xB152, "", "PCI to PCI Bridge" } ,
