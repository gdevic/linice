...
PCIHDR.H: PCI Vendors, Devices, and Class Type information
  ...
  This header created on Sat, 10 Aug 2002 18:36:53 UTC
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x0E11, 0xB030, "Netelligent WS 1500", "10/100TX UTP/Coax" } ,
	...
	{ 0x1000, 0x000A, "53C1510", "I2O-Ready PCI RAID Ultra2 SCSI Ctrlr" } ,
	{ 0x1000, 0x000B, "53C896/7", "dual-channel Ultra-2 Wide SCSI" } ,
	...
	{ 0x1000, 0x0010, "53C1510", "I2O-Ready PCI RAID Ultra2 SCSI Ctrlr" } ,
	{ 0x1000, 0x0012, "53C895A", "Ultra-2 Wide SCSI" } ,
	{ 0x1000, 0x0013, "53C875A", "PCI to Ultra SCSI Controller" } ,
	{ 0x1000, 0x0020, "53C1010-33", "PCI to Dual Channel Ultra3 SCSI Ctrlr" } ,
	{ 0x1000, 0x0021, "53C1000/1010-66", "PCI to Ultra160 SCSI Controller" } ,
	{ 0x1000, 0x0030, "53C1020/1030", "PCI-X to Ultra320 SCSI Controller" } ,
	{ 0x1000, 0x0031, "53C1030ZC", "PCI-X SCSI Controller" } ,
	{ 0x1000, 0x0035, "53C1035", "PCI-X SCSI Controller" } ,
	{ 0x1000, 0x0040, "53C1035", "PCI-X SCSI Controller" } ,
	...
	{ 0x1002, 0x4242, "", "Radeon 8500 DV Edition" } ,
	...
	{ 0x1002, 0x4966, "", "Radeon RV250" } ,
	{ 0x1002, 0x496E, "", "Radeon RV250 Secondary" } ,
	...
	{ 0x1002, 0x4C57, "", "Radeon Mobility 7500" } ,
	{ 0x1002, 0x4C58, "", "Radeon Mobility 7500 GL" } ,
	{ 0x1002, 0x4C59, "Mobility 6", "Radeon Mobility" } ,
	...
	{ 0x1002, 0x5144, "", "Radeon 7200 / Radeon" } ,
	...
	{ 0x1002, 0x514C, "Radeon QL", "Radeon 8500" } ,
	...
	{ 0x1002, 0x5246, "Rage 128 GL AGP 2x", "Rage Fury 16MB" } ,
	...
	{ 0x100B, 0x0011, "NS87560", "PCI System I/O" } ,
	...
	{ 0x1013, 0x9845, "CL-MD5620DT-QC-B", "V.90/56 PCI Modem" } ,
	{ 0x1013, 0x984A, "CL-MD5620DT-QC-B", "WINCOM V9.0 56K" } ,
	...
	{ 0x1014, 0x002E, "ServeRAID", "Coppertime RAID SCSI Adapter" } ,
	...
	{ 0x1014, 0x01BD, "ServeRAID 4x", "Morpheus SCSI RAID Controller" } ,
	{ 0x1014, 0x01BE, "ServeRAID 4M", "SCSI RAID Controller" } ,
	{ 0x1014, 0x01BF, "ServeRAID 4L", "SCSI RAID Controller" } ,
	{ 0x1014, 0x0208, "ServeRAID 4Mx", "SCSI RAID Controller" } ,
	{ 0x1014, 0x020E, "ServeRAID 4Lx", "SCSI RAID Controller" } ,
	{ 0x1014, 0x022E, "ServeRAID 4H", "SCSI RAID Controller" } ,
	...
	{ 0x1039, 0x7012, "SiS7012", "56Kb modem" } ,
	...
	{ 0x104C, 0xAC55, "PCI1520 GHK/PDV", "PC Card Controller" } ,
	...
	{ 0x1050, 0x0000, "", "Ethernet Controller (NE2000 compatible)" } ,
	...
	{ 0x1054, 0x1003, "HDL35B105-00GX", "SCSI host adapter" } ,
	...
	{ 0x1057, 0x5608, "SM56", "Voice Modem" } ,
	...
	{ 0x1073, 0x000D, "YMF724F", "PCI audio controller" } ,
	...
	{ 0x1095, 0x0680, "PCI-680", "UltraATA/133 EIDE Controller" } ,
	...
	{ 0x10B7, 0x6056, "3C556", "10/100 Mini PCI Fast Ethernet Adapter" } ,
	...
	{ 0x10DE, 0x002C, "NV5", "Vanta/Vanta LE" } ,
	...
	{ 0x10DE, 0x0101, "NV10", "GeForce DDR" } ,
	{ 0x10DE, 0x0102, "NV10", "GeForce Ultra" } ,
	{ 0x10DE, 0x0103, "NV10", "Quadro" } ,
	{ 0x10DE, 0x0110, "NV11", "GeForce 2 MX / MX 400" } ,
	{ 0x10DE, 0x0111, "NV11 DDR", "GeForce2 MX 200 " } ,
	{ 0x10DE, 0x0112, "NV11", "GeForce2 Go" } ,
	{ 0x10DE, 0x0113, "NV11 GL", "Quadro2 MXR/EX" } ,
	{ 0x10DE, 0x0150, "NV15", "GeForce2 GTS/Pro" } ,
	{ 0x10DE, 0x0151, "NV15 DDR", "GeForce2 GTS Ti " } ,
	{ 0x10DE, 0x0152, "NV15BR", "GeForce2 Ultra" } ,
	...
	{ 0x10DE, 0x0178, "NV17GL ", "Quadro4 500XGL" } ,
	{ 0x10DE, 0x0179, "NV17M", "GeForce4 440 Go 64M" } ,
	{ 0x10DE, 0x017A, "NV17GL ", "Quadro4 200/400NVS" } ,
	{ 0x10DE, 0x017B, "NV17GL", "Quadro4 550XGL" } ,
	{ 0x10DE, 0x017C, "NV17M-GL", "Quadro4 500 GoGL" } ,
	{ 0x10de, 0x0180, "NV18", "" } ,
	{ 0x10de, 0x0181, "NV18", "" } ,
	{ 0x10de, 0x0182, "NV18", "" } ,
	{ 0x10de, 0x0188, "NV18GL", "" } ,
	{ 0x10de, 0x018A, "NV18GL", "" } ,
	{ 0x10de, 0x018B, "NV18GL", "" } ,
	...
	{ 0x10DE, 0x01AA, "nForce 220", "Memory Controller (DDR)" } ,
	...
	{ 0x10DE, 0x01B1, "nForce", "Audio Codec Interface" } ,
	{ 0x10DE, 0x01B2, "nForce", "HUB Interface" } ,
	{ 0x10DE, 0x01B4, "nForce", "SMBus Controller" } ,
	{ 0x10DE, 0x01B7, "nForce AGP", "Host to PCI Bridge" } ,
	{ 0x10DE, 0x01B8, "nForce", "PCI Bridge" } ,
	{ 0x10DE, 0x01BC, "nForce", "ATA Controller" } ,
	{ 0x10DE, 0x01C2, "nForce", "OHCI USB Controller" } ,
	{ 0x10DE, 0x01C3, "nForce MCP", "Networking Adapter" } ,
	{ 0x10de, 0x01F0, "", "NVIDIA 0x01F" } ,
	...
	{ 0x10de, 0x0258, "NV25GL ", "Quadro4 900XGL" } ,
	{ 0x10de, 0x0259, "NV25GL ", "Quadro4 750XGL" } ,
	{ 0x10de, 0x025B, "NV25GL ", "Quadro4 700XGL" } ,
	{ 0x10de, 0x0280, "NV28", "" } ,
	{ 0x10de, 0x0281, "NV28", "" } ,
	{ 0x10de, 0x0288, "NV28GL", "" } ,
	{ 0x10de, 0x0289, "NV28GL", "" } ,
	...
	{ 0x10EC, 0x8029, "RTLL9029", "PCI Ethernet NIC" } ,
	...
	{ 0x1102, 0x0101, "GeForce 256 DDR", "Nvida Corp. Video" } ,
	...
	{ 0x1103, 0x0005, "HPT370", "UDMA/ATA 100 EIDE Controller" } ,
	...
	{ 0x1106, 0x0305, "VT8363/8365", "Host Bridge" } ,
	{ 0x1106, 0x0391, "VT8371", "Host Bridge" } ,
	...
	{ 0x1106, 0x3059, "VT8233", "AC97 Enhanced Audio Controller" } ,
	...
	{ 0x1106, 0x3116, "", "CPU-to-PCI Bridge" } ,
	...
	{ 0x1106, 0x3177, "VT8233A", "PCI to ISA Bridge" } ,
	...
	{ 0x1106, 0x8305, "VT8363/65", "PCI to AGP Bridge" } ,
	...
	{ 0x1106, 0xB116, "", "PCI-to-PCI Bridge (AGP)" } ,
	...
	{ 0x1131, 0x0222, "pdiusbd12", "usb interface device" } ,
	...
	{ 0x1142, 0x9751, "Promotion AT25", "video card for ISA bus" } ,
	...
	{ 0x1166, 0x0005, "NB6536 (CNB20HE)", "PCI to PCI Bridge, bus/dev/func 0/0/1" } ,
	{ 0x1166, 0x0006, "NB6536 (CNB20HE)", "Host Bridge, function 2 and function 3" } ,
	{ 0x1166, 0x0007, "NB6635 (CNB20-LE)", "CPU to PCI Bridge" } ,
	{ 0x1166, 0x0008, "NB6536 (CNB20HE)", "Hostbridge & MCH, bus/dev/func 0/0/0" } ,
	{ 0x1166, 0x0009, "NB6536 (CNB20HE)", "AGP interface" } ,
	{ 0x1166, 0x0010, "CIOB30", "" } ,
	{ 0x1166, 0x0011, "CMIC-HE", "" } ,
	{ 0x1166, 0x0012, "CMIC-LE", "" } ,
	{ 0x1166, 0x0013, "", "Hostbridge and MCH" } ,
	{ 0x1166, 0x0015, "", "Hostbridge and MCH" } ,
	...
	{ 0x1274, 0x5000, "es1370", "Audio PCI" } ,
	{ 0x1274, 0x5880, "5880", "Sound Blaster 16PCI and Sound Blaster4.1" } ,
	...
	{ 0x127A, 0x1005, "r6793-17", "HCF 56k V.90 Speakerphone Modem" } ,
	...
	{ 0x13A8, 0x0154, "XR17C154", "PCI Bus Quad UART" } ,
	{ 0x13A8, 0x0158, "XR17C158", "PCI Bus Octal UART" } ,
	...
	{ 0x13F6, 0x000D, "CMI8338-031", "PCI Audio Device" } ,
	...
	{ 0x14D2, 0xA003, "", "Visual Systems VScom PCI-400H Controller" } ,
	...
	{ 0x14E4, 0x1644, "BCM5700/5701", "Gigabit Ethernet Card" } ,
	...
	{ 0x14E4, 0x164D, "BCM5702FE", "Gigabit Ethernet" } ,
	...
	{ 0x14f1, 0x2013, "8850155D", "SoftK56 Winmodem" } ,
	...
	{ 0x14F1, 0x2046, "", "HSF 56k Data/Fax/Voice/Spkrphone Modem" } ,
	...
	{ 0x14F1, 0x2064, "", "HSF 56k Data/Fax/Voice Modem" } ,
	...
	{ 0x14F1, 0x2345, "", "HSF 56k Data/Fax/Voice/Sp CardBus Modem" } ,
	...
	{ 0x14F1, 0x2465, "", "HSF 56k Data/Fax/Voice/Spkrphone Modem" } ,
	...
	{ 0x14F1, 0x854, "RLVDL56DPF", "K56 FLEX, V.90, HCF controller" } ,
	...
	{ 0x1516, 0x0803, "803", "network controller" } ,
	...
	{ 0x1629, 0x1003, "", "Format Snchronizer v3.0" } ,
	...
	{ 0x5333, 0x8C2E, "86C583", "SuperSavage/IXC SDR" } ,
	...
	{ 0x8086, 0x1008, "82544EI/GC", "Gigabit Ethernet Controller" } ,
	...
	{ 0x8086, 0x1010, "82546EB", "Dual Gigabit Ethernet Controller" } ,
	...
	{ 0x8086, 0x1038, "82559", "Networking device" } ,
	...
	{ 0x8086, 0x1040, "536EP", "V.92 PCI Modem" } ,
	...
	{ 0x8086, 0x2448, "82801BAM/CAM", "Hub Interface to PCI Bridge (Camino 2)" } ,
	...
	{ 0x8086, 0x2486, "82801CA", "AC &#8217;97 Modem Controller" } ,
	...
	{ 0x8086, 0x248C, "82801CAM", "LPC Interface" } ,
	{ 0x8086, 0x24C0, "82801DB", "LPC Interface Bridge" } ,
	{ 0x8086, 0x24C2, "82801DB", "USB UHCI Controller #1" } ,
	{ 0x8086, 0x24C3, "82801DB", "SMBus Controller" } ,
	{ 0x8086, 0x24C4, "82801DB", "USB UHCI Controller #2" } ,
	{ 0x8086, 0x24C5, "82801DB", "AC97 Audio Controller" } ,
	{ 0x8086, 0x24C6, "82801DB", "AC97 Modem Controller" } ,
	{ 0x8086, 0x24C7, "82801DB", "USB UHCI Controller #3" } ,
	...
	{ 0x8086, 0x2541, "E7500", "DRAM Controller Error Reporting" } ,
	{ 0x8086, 0x2543, "E7500", "HI_B Virtual PCI-to-PCI Bridge" } ,
	{ 0x8086, 0x2544, "E7500", "HI_B PCI-to-PCI Bridge Error Reporting" } ,
	{ 0x8086, 0x2545, "E7500", "HI_C Virtual PCI-to-PCI Bridge" } ,
	{ 0x8086, 0x2546, "E7500", "HI_C PCI-to-PCI Bridge Error Reporting" } ,
	{ 0x8086, 0x2547, "E7500", "HI_D Virtual PCI-to-PCI Bridge" } ,
	{ 0x8086, 0x2548, "E7500", "HI_D PCI-to-PCI Bridge Error Reporting" } ,
	{ 0x8086, 0x2560, "82845G/GL", "DRAM Controller / Host-Hub I/F Bridge" } ,
	{ 0x8086, 0x2561, "82845G/GL", "Host-to-AGP Bridge" } ,
	{ 0x8086, 0x2562, "82845G/GL", "Integrated Graphics Device" } ,
	...
	{ 0x9710, 0x9815, "Nm9815", "Parallel/Serial Port Adapter" } ,
	...
	{ 0xEACE, 0x420E, "DAG 4.2E", "Gigabit Ethernet" } ,
