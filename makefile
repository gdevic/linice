...
linice.o: i386.o initial.o display.o command.o debugger.o dump.o registers.o disassembler.o unassemble.o interrupt.o keyboard.o vga.o convert.o ctype.o malloc.o string.o
	$(LD) -r $^ -o $@
